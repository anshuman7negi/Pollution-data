<h3 align="center"><b>Air Pollution</b></h3>

<p align="center">Air pollution is a single page application (SPA), where users can select any country and check their air quality.</p>
...
Air pollution is a single page application (SPA), where users can select any country and check their air quality.
...
> cd my-folder
> git clone https://github.com/anshuman7negi/Pollution-data.git
...
In this project I tried to replicate design template created by Nelson Sakwa on Behance.
